"""Regression checks for the signal-sim-capacity-lab casebook."""
...
from casebook.harness import assert_expected, signal_sim_capacity_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(signal_sim_capacity_lab_summary(), assert_expected())

...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-signal-sim-capacity-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-signal-sim-capacity-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-signal-sim-capacity-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-signal_sim_capacity_lab-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
